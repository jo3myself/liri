...
1. `node liri.js my-tweets`
   ...
   * This will show last 20 tweets and when they were created at in terminal/bash window.
...
4. `node liri.js do-what-it-says`
   ...
   * Using the `fs` Node package, LIRI will take the text inside of random.txt and then use it to call one of LIRI's commands.
     ...
     * It run `spotify-this-song` for "I Want it That Way," as follows the text in `random.txt`.
...
* Each command append to the `log.txt` file. 
